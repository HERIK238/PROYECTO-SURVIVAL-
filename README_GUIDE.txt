SURVIVAL - Guía rápida de instalación y uso
------------------------------------------
1) Descomprime este paquete en la carpeta raíz de tu servidor web local.
   - XAMPP: C:\xampp\htdocs\survival
   - Laragon: C:\laragon\www\survival
   - Linux: /var/www/html/survival (puede requerir permisos)

2) Base de datos:
   - Revisa el archivo de configuración de la base de datos en api/core (p. ej. DBConfig.php).
...
3) Puntos de entrada:
   - Abre en tu navegador: http://localhost/survival/
...
4) Archivos importantes y su función:
   ...
   - js/ -> Scripts del frontend (auth.js, dashboard.js, sidebar.js...).
   - css/ -> Estilos (login.css, main.css, ...).
   - layouts/ y ui/ -> Partes reutilizables como header, sidebar y footer.
...
6) Problemas comunes:
   ...
   - Error de conexión DB: abre api/core/DBConfig.php y ajusta los parámetros.
