// Sistema AR de Survival

// Registrar sistema principal de Survival
AFRAME.registerSystem('survival', {
    init: function () {
        ...
        console.log('🏕️ Sistema Survival AR inicializado');
    ...
    updateUIAfterSurfaceCreation: function() {
        try {
            ...
            if (statusElement) {
                statusElement.innerHTML =
                    '✅ <span class="surface-detected">Superficie Survival detectada y lista</span>';
            }
    ...
    createDeployedItem: function(category, surface) {
        try {
            ...
            element.setAttribute('class', 'survival-item interactive');
            ...
            const homelabContainer = document.getElementById('survival-container');
            if (homelabContainer) {
    ...
    createInteractivePage: function(pageData, position) {
        try {
            ...
            page.setAttribute('class', 'survival-item interactive');
            ...
            if (survivalContainer) {
                survivalContainer.appendChild(page);
